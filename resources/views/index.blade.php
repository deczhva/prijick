        ...
        <ul class="menu">
            ...
            <li
                ...
                <a href="#" class='sidebar-link'>
                    ...
                    <span>Data Mazer</span>
                </a>
                <ul class="submenu ">
                    <li class="submenu-item ">
                        <a href="/mom">Data Ibu</a>
                    </li>
                    <li class="submenu-item ">
                        <a href="component-badge.html">Data Anak</a>
                    </li>
                    <li class="submenu-item ">
                        <a href="component-breadcrumb.html">Data Imunisasi</a>
                    </li>
                    <li class="submenu-item ">
                        <a href="component-button.html">Vitamin</a>
                    </li>
                    <li class="submenu-item ">
            ...
            <li
                ...
                <ul class="submenu ">
                    <li class="submenu-item ">
                        <a href="extra-component-avatar.html">Laporan Anak</a>
                    </li>
                    <li class="submenu-item ">
                        <a href="extra-component-sweetalert.html">Laporan Imunisasi</a>
                    </li>
                    <li class="submenu-item ">
                        <a href="extra-component-toastify.html">Laporan Penimbangan</a>
                    </li>
                    <li class="submenu-item ">
                        <a href="extra-component-rating.html">Laporan SPPD</a>
                    </li>
                    <li class="submenu-item ">
                        <a href="extra-component-divider.html">Laporan Kegiatan</a>
                    </li>
                    <li class="submenu-item ">
                        <a href="extra-component-divider.html">Kwitansi</a>
                    </li>
                </ul>
            </li>
