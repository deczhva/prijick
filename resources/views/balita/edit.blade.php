...
@foreach ($balita as $n)
    {{-- @dd($newMember) --}}
    <div class="modal fade" id="edit-balita{{ $n->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <form action="{{ url('balita/update/' . $n->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col">
                                    <label for="nama">Nama</label>
                                    <input name="nama_anak" type="text" class="form-control"
                                        value="{{ $n->nama_anak }}">
                                </div>
                            </div>
                    </div>
                    <div class="container-fluid mt-3">
                        <div class="row">
                            <div class="col">
                                ...
                                <input name="nik_anak" type="text" class="form-control" value="{{ $n->nik_anak }}">
                            </div>
                            <div class="col">
                                <label for="tgl_lahir">Tanggal Lahir</label>
                                <input type="date" class="form-control" name="tgl_lahir" value="{{ $n->tgl_lahir }}">
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid mt-3">
                    ...
                    <div class="container-fluid mt-3">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="kia" value="{{ $n->kia }}">
                            </div>
                            <div class="col">
                                <label for="imd">IMD</label>
                                <input type="text" class="form-control" name="kia" value="{{ $n->IMD }}">
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid mt-3">
                    ...
                    <div class="container-fluid mt-3">
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" id="floatingTextarea2" style="height: 100px" name="alamat">{{ $n->alamat }}</textarea>
                            </div>
                        </div>
